...
const getAddressUTXOHandlerFactory = require(
  './getAddressUTXOFactory',
);
...
function coreHandlersFactory(coreRPCClient, isProductionEnvironment) {
  ...
  // getAddressUTXO
  const getAddressUTXOHandler = getAddressUTXOHandlerFactory(coreRPCClient);
  const wrappedGetAddressUTXO = jsonToProtobufHandlerWrapper(
    jsonToProtobufFactory(
      GetAddressUTXORequest,
    ...
    wrapInErrorHandler(getAddressUTXOHandler),
  );
  return {
    ...
    getAddressUTXO: wrappedGetAddressUTXO,
  };
}
